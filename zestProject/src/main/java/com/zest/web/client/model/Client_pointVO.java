...
public class Client_pointVO {
	...
	public String toString() {
		return "Client_pointVO [cp_no=" + cp_no + ", cl_no=" + cl_no + ", to_no=" + to_no + ", cp_type=" + cp_type
				+ ", cp_in_point=" + cp_in_point + ", cp_out_point=" + cp_out_point + ", cp_total_point="
				+ cp_total_point + ", cp_date=" + cp_date + "]";
	}
